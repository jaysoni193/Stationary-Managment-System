...
$meta_title="Stationary Website";
$meta_desc="Stationary Website";
$meta_keyword="Stationary Website";
                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5"> 
                                <div class="logo">
                                     <a href="index.php"><img src="images/logo/1.png" alt="logo images">Only WholeSale</a>
                                </div>
                            </div>
